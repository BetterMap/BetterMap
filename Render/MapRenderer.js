...
class MapRenderer {
    ...
    draw(renderContext, dungeonMap, mouseX, mouseY) {
        ...
        // BACKROUND COLOR
        Renderer.drawRect(Renderer.color(renderContext.settings.mapBackgroundColor[0], renderContext.settings.mapBackgroundColor[1], renderContext.settings.mapBackgroundColor[2], renderContext.settings.mapBackgroundColor[3]), x, y, size, size)//background
        ...
        Renderer.drawRect(Renderer.color(renderContext.settings.borderColor[0], renderContext.settings.borderColor[1], renderContext.settings.borderColor[2], renderContext.settings.borderColor[3]), x, y, size, renderContext.borderWidth) //border
        Renderer.drawRect(Renderer.color(renderContext.settings.borderColor[0], renderContext.settings.borderColor[1], renderContext.settings.borderColor[2], renderContext.settings.borderColor[3]), x, y, renderContext.borderWidth, size)
        Renderer.drawRect(Renderer.color(renderContext.settings.borderColor[0], renderContext.settings.borderColor[1], renderContext.settings.borderColor[2], renderContext.settings.borderColor[3]), x + size - renderContext.borderWidth, y, renderContext.borderWidth, size)
        ...
        if (renderContext.scoreInfoUnderMap === "simplified") {
            ...
            Renderer.drawRect(Renderer.color(renderContext.settings.borderColor[0], renderContext.settings.borderColor[1], renderContext.settings.borderColor[2], renderContext.settings.borderColor[3]), x, y + size, renderContext.borderWidth, scoreInfoHeight) //border of score info
            Renderer.drawRect(Renderer.color(renderContext.settings.borderColor[0], renderContext.settings.borderColor[1], renderContext.settings.borderColor[2], renderContext.settings.borderColor[3]), x + size - renderContext.borderWidth, y + size, renderContext.borderWidth, scoreInfoHeight)
            Renderer.drawRect(Renderer.color(renderContext.settings.borderColor[0], renderContext.settings.borderColor[1], renderContext.settings.borderColor[2], renderContext.settings.borderColor[3]), x, y + size + scoreInfoHeight, size, renderContext.borderWidth)
            ...
            Renderer.drawRect(Renderer.color(renderContext.settings.borderColor[0], renderContext.settings.borderColor[1], renderContext.settings.borderColor[2], renderContext.settings.borderColor[3]), x, y + size, size, renderContext.borderWidth)
        }
