  ...
  getImage(type) {
    switch (this.tickStyle) {
      case "default":
        ...
        let scaledDownImage = new BufferedImage(
          Math.floor(size[0] / 2),
          Math.floor(size[1] / 2),
...
HypixelColorMap.set(
  roomHash.NORMAL,
  new Color(Renderer.color(114, 67, 27, 255))
);
HypixelColorMap.set(
  roomHash.NORMAL_CONNECTION,
  new Color(Renderer.color(114, 67, 27, 255))
);
HypixelColorMap.set(
  roomHash.PUZZLE,
  new Color(Renderer.color(178, 76, 216, 255))
);
HypixelColorMap.set(
  roomHash.MINIBOSS,
  new Color(Renderer.color(229, 229, 51, 255))
);
HypixelColorMap.set(
  roomHash.FAIRY,
  new Color(Renderer.color(242, 127, 165, 255))
);
HypixelColorMap.set(roomHash.BLOOD, new Color(Renderer.color(255, 0, 0, 255)));
HypixelColorMap.set(
  roomHash.TRAP,
  new Color(Renderer.color(216, 127, 51, 255))
);
HypixelColorMap.set(
  roomHash.UNKNOWN,
  new Color(Renderer.color(65, 65, 65, 255))
);
HypixelColorMap.set(roomHash.BLACK, new Color(Renderer.color(0, 0, 0, 255)));

const LegalMapColorMap = new Map();
LegalMapColorMap.set(
  roomHash.SPAWN,
  new Color(Renderer.color(20, 133, 0, 255))
);
LegalMapColorMap.set(
  roomHash.NORMAL,
  new Color(Renderer.color(107, 58, 17, 255))
);
LegalMapColorMap.set(
  roomHash.NORMAL_CONNECTION,
  new Color(Renderer.color(92, 52, 14, 255))
);
LegalMapColorMap.set(
  roomHash.PUZZLE,
  new Color(Renderer.color(117, 0, 133, 255))
);
LegalMapColorMap.set(
  roomHash.MINIBOSS,
  new Color(Renderer.color(254, 223, 0, 255))
);
LegalMapColorMap.set(
  roomHash.FAIRY,
  new Color(Renderer.color(224, 0, 255, 255))
);
...
HypixelTicksOld.set(
  "greenCheck",
  Image.fromAsset("greenCheckVanilla-old.png").image
);
HypixelTicksOld.set(
  "whiteCheck",
  Image.fromAsset("whiteCheckVanilla-old.png").image
);
HypixelTicksOld.set(
  "failedRoom",
  Image.fromAsset("failedRoomVanilla.png").image
);
HypixelTicksOld.set(
  "questionMark",
  Image.fromAsset("questionMarkVanilla-old.png").image
);

const HypixelTicksNew = new Map();
HypixelTicksNew.set(
  "greenCheck",
  Image.fromAsset("greenCheckVanilla-new.png").image
);
HypixelTicksNew.set(
  "whiteCheck",
  Image.fromAsset("whiteCheckVanilla-new.png").image
);
HypixelTicksNew.set(
  "failedRoom",
  Image.fromAsset("failedRoomVanilla.png").image
...
HypixelTicksNew.set(
  "questionMark",
  Image.fromAsset("questionMarkVanilla-new.png").image
);
...
NEUMapTicks.set(
  "questionMark",
  Image.fromAsset("NEUMapQuestionMark.png").image
); //old: https://i.imgur.com/kp92Inw.png
